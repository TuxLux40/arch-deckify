<div align="center">
	<br />
	<p>
	<img src="https://raw.githubusercontent.com/TuxLux40/arch-deckify/refs/heads/main/banner.png" width="500" alt="Banner" /></a>
	</p>
	<br />
	<p>
</div>
...
```bash
bash <(curl -sSL https://raw.githubusercontent.com/TuxLux40/arch-deckify/refs/heads/main/install.sh)
```
...
```bash
bash <(curl -sSL https://raw.githubusercontent.com/TuxLux40/arch-deckify/refs/heads/main/change_default_desktop.sh)
```
...
```bash
bash <(curl -sSL https://raw.githubusercontent.com/TuxLux40/arch-deckify/refs/heads/main/setup_deckyloader.sh)
```

**To remove Decky Loader:**

```bash
bash <(curl -sSL https://raw.githubusercontent.com/TuxLux40/arch-deckify/refs/heads/main/remove_deckyloader.sh)
```
